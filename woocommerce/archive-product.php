...
$blog_column = is_active_sidebar( 'woocommerce-sidebar' ) ? 8 : 12;

get_header( 'shop' );
?>

<div class="product-archive-page section-padding">
	<div class="container">
		<div class="row">
			<?php if ( is_active_sidebar( 'woocommerce-sidebar' ) ): ?>
			<div class="col-xl-4 col-lg-4">
				<div class="sidebar woo-sidebar mr-40">
					<?php do_action( 'woocommerce-sidebar' );?>
				</div>
			</div>
		<?php endif;?>
